...
const server = new McpServer({ name: 'coderabbitai-cli-mcp', version: pkg.version }, {
    ...
    instructions: 'Use run_review for CodeRabbit CLI execution, ensure_cli/install_cli for bootstrap, and auth_* tools for authentication. Outputs are mirrored under report:// resources.'
});
const levelMap = {
    DEBUG: 'debug',
    INFO: 'info',
